            ...
            switch (menu) {
                ...
                case 4: {
                    ...
                    if (vehi.get(posicion) instanceof vehiculo && posicion >= 0 && posicion < vehi.size() && saldocliente > preciocarro) {
                        ...
                        System.out.println(cliente);
                        double nuevodinerocliente = saldocliente - preciocarro;
                        double nuevodineroconse = dineroc + preciocarro;
                        ((consecionaria) conse.get(posicion)).setSaldo(nuevodineroconse);
                        ((consecionaria) conse.get(posicion)).getCliente().add(cliente.get(poscliente));
                        ((consecionaria) conse.get(posicion)).setSaldo(nuevodinerocliente);
                    } else {
